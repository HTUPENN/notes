...
class SimpleOPCUAClient:
    def __init__(self, endpoint="opc.tcp://localhost:4840"):
        ...
        Args:
            endpoint (str): 服务器端点地址，默认本地4840端口
        """
    ...
    def get_node_by_path(self, node_path):
        ...
        Args:
            node_path (list): 节点路径列表

        Returns:
            Node: 找到的节点对象，失败返回None
        """
        try:
            # 直接使用完整节点ID路径
    ...
    def get_node_by_browse(self, browse_path):
        ...
        Args:
            browse_path (list): 浏览路径列表，如["0:Objects", "2:Device"]
    ...
    def read_value(self, node_path=None, browse_path=None):
        ...
        try:
            if browse_path:
                # browse_path 格式: browse_path=["0:Objects", "2:SimpleDevice", "2:Temperature"]
